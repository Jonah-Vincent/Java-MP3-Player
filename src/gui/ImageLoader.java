...
public class ImageLoader
{
   ...
   public Image getMetalFilteredImage(Image img)
   {
   		...
   		bGr.dispose();
   		Image returnimage = filter.filter(image,null);
   		return returnimage;
   }
}
...
class BrushedMetalFilter implements BufferedImageOp //credit for this code https://github.com/ajmas/JH-Labs-Java-Image-Filters/blob/master/src/com/jhlabs/image/BrushedMetalFilter.java 
{
